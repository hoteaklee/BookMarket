...
public class J22Generic {
    ...
    public static  void main(String[] args) {
        ...
        Object[] zoo = new Object[10];  //최상위 클래스 Object

        // 동물들을 동물원 우리에 가둠
        zoo[0] = new Lion();    // upcastiong!
        zoo[1] = new Tiger();
        zoo[2] = new Zebra();
        ...
        // 데이터 유형을 미리 설정해 둠
        List<Lion> lionzoo = new ArrayList<>(); //lionzoo 에는 lion 만 들어올수 있게 설정함

        lionzoo.add(new Lion());
        //lionzoo.add(new Tiger()); // 컴파일타임 오류 발생! (Lion만 들어갈수 있음)
        ...
        // 실행중에 필요시에 따라 타입을 매개변수 형태로 받아 사용함
        // 비슷한 기능을 지원하는 코드들을 간략하게 작성할 수 있어
        // 코드의 재사용성이 높아짐
        System.out.println( example.add(new Integer(10),new Integer(100) ) );
        System.out.println( example.add(new Double(5.5),new Double(10.3) ) );
        System.out.println( example.add(new Float(3.5f),new Float(7.3f) ) );
...
class Adds {
    ...
    // 타입 T 에 int를 쓰면 됨( 여러게 메서드들 하나로 만들수 있음)

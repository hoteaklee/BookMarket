...
public class C01Datatype {
   public static void main(String[] args) {
       ...
       int a= 3;
       int b = 5;
       //int c= 1.5;  // 1.5는 정수형이 아니라 실수라서 오류남
       ...
       //  아래 값이 long 숫자임을 나타내기 위해 L 접미사 추가
       ...
       int tot = kor+ eng + mat;
       //double avg = tot/3;
       //double avg = (kor+ eng + mat)/3; //정수를 정수로 나누면  정수가 나옴
       double avg = (kor+ eng + mat)/3.0; // 정수를 실수로 나누면 결과는 실수 나옴

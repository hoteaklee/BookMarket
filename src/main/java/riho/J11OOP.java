...
public class J11OOP {
    public static void main(String[] args) {
        ...
        // Ex) 주소록 프로그램을 작성하려고 할떄
        // 사람 정보를 정장하는 클래스 정의가 필요!
        // 개인정보 : 이름, 직업, 나이, 성별
        ...
        // 매개변수 생성자로 객체 초기화
        Person p2 = new Person("수지","이이돌",30,'여');
        // 객체 출력
  ...
  // 클래스 정의 - 서로 다른 자료형으로 구성된 데이터들의 집합 (배열이랑 비교했을때 배열은 동일한 자료형)
class Person {
    // 멤버변수 : 클래스를 구성하는 변수
    String name;
    String job;
    ...
    // 생성자 : 멤버변수에 값을 초기화하는 특별한 메서드 (constructor)
      // public 클래스명(매개변수, ...) {
      // 변수초기화
      //}
      public Person() {} // 기본 생성자 (위에  Person p1 = new Person(); 이거 떄문에)
